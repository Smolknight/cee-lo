...
function typer(){
    ...
    switch(flag.eraseFlag){
        ...
        case 8: 
            ...
            break;
        case 9: 
        storyChange.text=`four outcomes`
        break;
        case 10:
        ...
        case 14:
            ...
            break;
        case 15: storyChange.text=`The best case is making out thousands of dollars richer than you were before`
        break;
        case 16: storyChange.text=`five minutes`
        break;
        case 17: storyChange.text=`every point gained is a dollar earned`
        break;
        case 18: storyChange.text=`Good luck`
        break;
}
...
function eraser(){
    ...
    if(i==0){
        ...
        if(flag.eraseFlag<19){
            lol=setInterval(typer,45)
        }else{
            story.innerHTML=`<button>Play</button>`
        }
    }
}
